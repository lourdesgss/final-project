...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./report_chapters/7_network_redesign/img/logic_redesign.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{report_chapters/7_network_redesign/img/redesign_iml.pdf}
...
for each node withing that VLAN.
...
\pagebreak
\subsection{Justified Protocols Routes}
...
and re-innitiated in the IDMZ proxy to the other side. \\ \vspace{1em}
